...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        centralFrame->setStyleSheet(QStringLiteral("background-color: rgba(0, 0, 0, 40);"));
...
"background-color:rgba(0,0,0,0);"));
        ...
        lineEdit->setStyleSheet(QStringLiteral("background-color: rgba(255, 255, 255,230);"));

        gridLayout->addWidget(lineEdit, 1, 0, 1, 1);

        pushButton = new QPushButton(centralWidget);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setStyleSheet(QLatin1String("font: 75 9pt \"Ubuntu\";\n"
"color: rgb(255, 255, 255);\n"
"background-color: rgba(0, 0, 255, 230);"));
        ...
        filters = new QPushButton(bottomWidget);
        ...
        emptyLabel = new QLabel(bottomWidget);
